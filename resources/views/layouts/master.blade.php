...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="alert alert-success margin-top:5">{{session('statusedit')}}</div>
        @endif
        @if (session('status'))
        <div class="alert alert-danger margin-top:5">{{session('status')}}</div>
        @endif
        <!-- /#header -->
        <!-- Content -->
        <div class="content">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count">{{$tuser->count('id')}}</span></div>
